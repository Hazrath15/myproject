			...
			<div id="main">
				<section class="wrapper style1">
					<div class="inner">
						...
						<!-- Elements -->
							<h4 id="elements">Shahid President Ziaur Rahman Hall</h4>
							<div class="row 200%">
								<div class="6u 12u$(medium)">
										<hr />
										<p><span class="image fit"><img src="images/ziahall.jpg" alt="photo of Zia Hall" /></span>
										...
										<form method="post" name="listForm" action="zia.php">
                      <div class="row uniform">
								...
								<div class="6u$ 12u$(medium)">
									...
									<!-- Box -->
										...
										<hr/>
										<blockquote>
                      Provost:Prof. Dr. Md. Shahidul Islam<br>
											Contact:+880-721 750742 Ext (605),+8801191014965 <br>
											Fringilla nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan faucibus. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis.</blockquote>
                <hr/>
										<h3>Complain</h3>

										<form method="post" action="zia.php">
											<div class="row uniform">
												<div class="6u 12u$(xsmall)">
                        ...
                        <div class=" 12u$">
                          <input type="text" name="hallname" id="hallname" value="Ziaur Rahman hall" placeholder="Hall Name" />
                        </div>
												<!-- Break -->
												<div class="12u$">
						...
						<form method="post" action="ziahall.php">
							<div class="row uniform">
