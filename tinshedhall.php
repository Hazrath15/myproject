...
<html>
	<head>
		<title>Tin Shed Hall (Extension)-RUET</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				<section class="wrapper style1">
					<div class="inner">
						...
						<!-- Elements -->
							<h4 id="elements">Tin Shed Hall (Extension)</h4>
							<div class="row 200%">
								<div class="6u 12u$(medium)">
										<hr />
										<p><span class="image fit"><img src="images/tinshedhall.jpg" alt="" /></span>
										...
										<form method="post" name="listForm" action="tinshed.php">
                      <div class="row uniform">
								...
								<div class="6u$ 12u$(medium)">
									...
									<!-- Box -->
										...
										<hr/>
										<blockquote>
                      Provost:Md. Mohibul Islam(Astt. Provost)<br>
											Contact:++880-721 750742 Ext (187),+8801918802600 <br>
											Fringilla nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan faucibus. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis.</blockquote>
                   <hr/>
										<h3>Complain</h3>

										<form method="post" action="tinshed.php">
											<div class="row uniform">
												<div class="6u 12u$(xsmall)">
                        ...
                        <div class=" 12u$">
													<input type="text" name="hallname" id="hallname" value="Tinshed Hall" placeholder="Hall Name" />
												</div>
						...
						<form method="post" action="tinshedhall.php">
							<div class="row uniform">
