...
<html>
	<head>
		<title>Deshratna Sheikh Hasina Hall-RUET</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				<section class="wrapper style1">
					<div class="inner">
						...
						<!-- Elements -->
							<h4 id="elements">Deshratna Sheikh Hasina Hall</h4>
							<div class="row 200%">
								<div class="6u 12u$(medium)">
										<hr />
										<p><span class="image fit"><img src="images/ladieshall.jpg" alt="" /></span>
										...
										<form method="post" name="listForm" action="hasina.php">
                            ...
                            <li><input type="reset" value="Reset" class="alt" /></li>
								...
								<div class="6u$ 12u$(medium)">
									...
									<!-- Box -->
										...
										<hr/>
										<blockquote>
                      Provost:Prof. Dr. Engr. M. N. I Mondal <br>
											Contact:+880-721 750742 Ext (189),+01720662278, +8801912744327 <br>
											Fringilla nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan faucibus. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis.</blockquote>
                  <hr/>
										<h3>Complain</h3>

										<form method="post" action="hasina.php">
											<div class="row uniform">
												<div class="6u 12u$(xsmall)">
                        ...
                        <div class=" 12u$">
                          <input type="text" name="hallname" id="hallname" value="Sheikh Hasina Hall" placeholder="hall Name" />
                        </div>
						...
						<form method="post" action="hasinahall.php">
							<div class="row uniform">
