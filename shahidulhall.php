...
<html>
	<head>
		<title>Shahid Shahidul Islam Hall-RUET</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				<section class="wrapper style1">
					<div class="inner">
						...
						<!-- Elements -->
							<h4 id="elements">Shahid Shahidul Islam Hall</h4>
							<div class="row 200%">
								<div class="6u 12u$(medium)">
										<hr />
										<p><span class="image fit"><img src="images/shahidulhall.jpg" alt="photo of shahidul hall" /></span>
										...
										<form method="post" name="listForm" action="shahidul.php">
                            ...
                            <li><input type="reset" value="Reset" class="alt" /></li>
								...
								<div class="6u$ 12u$(medium)">
									...
									<!-- Box -->
										...
										<hr/>
										<blockquote>
                      Provost: Dr. Md. Al Mamun<br>
											Contact:+880-721 750742 Ext (185),+880-721 750282, 01712622584  <br>
											Fringilla nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan faucibus. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis.</blockquote>
                    <hr/>
										<h3>Complain</h3>

										<form method="post" action="shahidul.php">
											<div class="row uniform">
												<div class="6u 12u$(xsmall)">
                        ...
                        <div class=" 12u$">
                          <input type="text" name="hallname" id="hallname" value="Shahidul Hall" placeholder="Hall Name" />
                        </div>
						...
						<form method="post" action="shahidulhall.php">
							<div class="row uniform">
