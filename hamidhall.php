...
<html>
	<head>
		<title>Shahid Abdul Hamid Hall-RUET</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				<section class="wrapper style1">
					<div class="inner">
						...
						<!-- Elements -->
							<h4 id="elements">Shahid Abdul Hamid Hall</h4>
							<div class="row 200%">
								<div class="6u 12u$(medium)">
										<hr />
										<p><span class="image fit"><img src="images/hamidhall.jpg" alt="" /></span>
										...
										<form method="post" name="listForm" action="hamid.php">
								...
								<div class="6u$ 12u$(medium)">
									...
									<!-- Box -->
										...
										<hr/>
										<blockquote>
                      Provost:Prof. Dr. Md. Robiul Awall<br>
											Contact: +880-721 750742 Ext (183),+880-721 750034, 01711302330 <br>
											Fringilla nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan faucibus. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis.</blockquote>
                  <hr/>
										<h3>Form</h3>

										<form method="post" action="hamid.php">
											<div class="row uniform">
												<div class="6u 12u$(xsmall)">
                        ...
                        <div class=" 12u$">
													<input type="text" name="hallname" id="hallname" value="Hamid Hall" placeholder="Hall Name" />
												</div>
						...
						<form method="post" action="hamidhall.php">
							<div class="row uniform">
