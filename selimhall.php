...
<html>
	<head>
		<title>Shahid Lt. Selim Hall-RUET</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				<section class="wrapper style1">
					<div class="inner">
						...
						<!-- Elements -->
							<h4 id="elements">Shahid Lt. Selim Hall</h4>
							<div class="row 200%">
								<div class="6u 12u$(medium)">
										<hr />
										<p><span class="image fit"><img src="images/selimhall.jpg" alt="" /></span>
										...
										<form method="post" name="listForm" action="selim.php">
                            ...
                            <li><input type="reset" value="Reset" class="alt" /></li>
								...
								<div class="6u$ 12u$(medium)">
									...
									<!-- Box -->
										...
										<hr/>
										<blockquote>
                      Provost:Prof. Dr. S. M. Zuhurul Islam <br>
                   ...
                   <hr/>
										...
										<form method="post" action="selim.php">
											<div class="row uniform">
												<div class="6u 12u$(xsmall)">
                        ...
                        <div class=" 12u$">
                          <input type="text" name="hallname" id="hallname" value="Selim Hall" placeholder="Hall Name" />
                        </div>
						...
						<form method="post" action="selimhall.php">
							<div class="row uniform">
